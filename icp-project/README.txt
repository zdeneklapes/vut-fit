...
Plně funkční implementace:
    ...
    - Při interaktivních zásazích je zohledněna provázanost diagramu tříd a sekvenčních diagramů. A to přesně:
       ...
       - smazání entity v sekvenčím diagramu pri smazáni třídy v diagramu tříd
    - Diagram tříd:
...
Popis:
    ...
    - Aplikace podporuje vytváření diagramů vrámci jen jedné scény.
    - Aplikace se načte se základním přiblížením "zoom". Při otevření diagramu bude možná potřeba oddálit scénu pomocí
      "zoom out" funkce.
...
Vytváření sekvenčního diagramu:
    ...
    - Vytváření zpráv.
        ...
        - Pro smazání zprávy je třeba označit červené tlačítko na začátku každé zprávy.
...
Copyright / inspirace:
    ...
    - https://medium.com/@uferesamuel/uml-class-diagrams-the-simple-approach-eee2d1ffc125
